...
import { Aircraft, SavedAircraft, aircraftList } from "../data/aircraft";
...
export default function AircraftForm({ template: initialTemplate, isEditMode, onSave, onCancel }: AircraftFormProps) {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      {/* MODAL CARD */}
      <div className="max-w-2xl w-full max-h-[90vh] overflow-y-auto bg-white dark:bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700">
        <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white sticky top-0 bg-white dark:bg-gray-800 z-10 pb-4 border-b border-gray-100 dark:border-gray-700">
        ...
        <div className="space-y-6 mt-4">
          ...
          {/* ACTIONS */}
          <div className="flex gap-4 pt-4 border-t border-gray-100 dark:border-gray-700 sticky bottom-0 bg-white dark:bg-gray-800 pb-2">
            <button 
              onClick={handleSave}
              disabled={!reg}
            ...
            <button 
              onClick={onCancel}
              className="px-6 py-3 text-gray-500 dark:text-gray-400 font-bold hover:text-gray-800 dark:hover:text-gray-200 transition"
            >
              Cancel
            </button>
          </div>
